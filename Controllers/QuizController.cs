...
namespace QuizApplicationMVC.Controllers
{
    public class QuizController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Include User and Questions when fetching the quiz
            ...
            Console.WriteLine(quiz?.User); // Use null-conditional operator to avoid NullReferenceException
            ...
            // If you want to log the number of questions for debugging purposes
...
public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Duration")] Quiz quiz)
{
    ...
    // If model state is invalid, return the same view with the current quiz data
    return View(quiz);
}
